...
def edit_recipe(id):
    ...
    user = User.get_by_id(formulario) #Usuario que inició sesión (de la 40-44 es para obtener el usuario)
...
def show_recipe(id):
    ...
    user = User.get_by_id(formulario) #Usuario que inició sesión (69-73 esta info se la enviamos a la platilla)
